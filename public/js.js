...
function temperature(tempAmount) {
  if(tempAmount >= 85) {
      ...
      $("#tempDisplay").html("<img src='images/hotweather.png' alt='temp' style='width:100px; height:100px'/> <p class='text-center'> <strong> Warm! The temperature is: " + tempAmount + "</strong></p>");

  } else if ( tempAmount < 65 && tempAmount >= 55) {
      $("#tempDisplay").html("<img src='images/coldWeather.jpg' alt='temp' style='width:100px; height:100px'/> <p class='text-center'><strong> Getting chilly...The temperature is: " + tempAmount + "</strong></p>");

  } else if ( tempAmount < 55 && tempAmount >= 32) {
      $("#tempDisplay").html("<img src='images/coldWeather.jpg' alt='temp' style='width:100px; height:100px'/> <p class='text-center'> <strong> Take a jacket. The temperature is: " + tempAmount + "</strong></p>");

  } else if ( tempAmount < 32 ) {
      $("#tempDisplay").html("<img src='images/coldWeather.jpg' alt='temp' style='width:100px; height:100px'/> <p class='text-center'> <strong> It's freezing! The temperature is: " + tempAmount + "</strong></p>");
  }
};
